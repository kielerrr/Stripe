...
if (isset($_POST['action']) && $_POST['action'] == "get_client") {
    ...
    $arr = array(
        'name' => $sp->sources->data[0]['account_holder_name'],
        'acount_no' => $sp->sources->data[0]['last4'],
        'routing_no' => $sp->sources->data[0]['routing_number'],
        'bank_status' => $sp->sources->data[0]['status'],
        'id' => $sp->sources->data[0]['id'],
        'customer' => $sp->sources->data[0]['customer'],
    );
